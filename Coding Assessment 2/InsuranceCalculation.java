...
class InsuranceCal {
    ...
    public InsuranceCal(String insuranceNo, String insuranceName, double amountCovered) {
...
class LifeInsurance extends InsuranceCal{
...
class MotorInsurance extends InsuranceCal{
